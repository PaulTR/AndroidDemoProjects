...
public class AutoMediaBrowserService extends MediaBrowserService implements MediaPlayer.OnPreparedListener,
    ...
    private void initMediaSessions() {
        mSession = new MediaSession( this, "Auto Media Service" );
    ...
    private void initCallbacks() {
        mMediaSessionCallbacks = new MediaSession.Callback() {
            ...
            public void onPlay() {
                super.onPlay();
                Log.e( "AutoMediaBrowserService", "onPlay" );
            }

            @Override
            public void onPause() {
                super.onPause();
                Log.e( "AutoMediaBrowserService", "onPause" );
            }

            @Override
            public void onSkipToNext() {
                super.onSkipToNext();
                Log.e( "AutoMediaBrowserService", "onSkipToNext" );
            }

            @Override
            public void onSkipToPrevious() {
                super.onSkipToPrevious();
                Log.e( "AutoMediaBrowserService", "onSkipToPrevious" );
            }

            @Override
            public void onFastForward() {
                super.onFastForward();
                Log.e( "AutoMediaBrowserService", "onFastForward" );
            }

            @Override
            public void onRewind() {
                super.onRewind();
                Log.e( "AutoMediaBrowserService", "onRewind" );
            }

            @Override
            public void onStop() {
                super.onStop();
                Log.e( "AutoMediaBrowserService", "onStop" );
            }

            @Override
            public void onSeekTo(long pos) {
                super.onSeekTo(pos);
                Log.e( "AutoMediaBrowserService", "onSeekTo" );
            }

            @Override
            public void onSetRating(Rating rating) {
                super.onSetRating(rating);
                Log.e( "AutoMediaBrowserService", "onSetRating" );
            }
    ...
    public BrowserRoot onGetRoot(String clientPackageName, int clientUid, Bundle rootHints) {
        ...
        if (!isCallerAllowed(this, clientPackageName, clientUid)) {
    ...
    public static boolean isCallerAllowed(Context context, String callingPackage, int callingUid) {
        ...
        if (android.os.Process.SYSTEM_UID == callingUid || !"user".equals(Build.TYPE)) {
            return true;
        }
